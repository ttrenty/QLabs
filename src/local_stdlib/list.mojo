...
from memory import Pointer, memcpy, memset_zero
...
struct _ListIter[
    ...
    alias list_type = CustomList[T, hint_trivial_type]
...
struct CustomList[T: Copyable & Movable, hint_trivial_type: Bool = False](
    ...
    fn memset_zero(mut self):
        """Sets all elements in the list to zero."""

        @parameter
        if hint_trivial_type:
            memset_zero(self.data, len(self))
        else:
            return  # TODO: how to reset to 0 unknown type?
